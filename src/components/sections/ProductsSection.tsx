...
const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      '/images/products/kit-mamoplastia/1.jpg',
      '/images/products/kit-mamoplastia/2.jpg',
      '/images/products/kit-mamoplastia/3.jpg',
    ],
    tag: 'Kit Completo',
  },
  {
    ...
    images: [
      '/images/products/kit-abdominoplastia/1.jpg',
      '/images/products/kit-abdominoplastia/2.jpg',
      '/images/products/kit-abdominoplastia/3.jpg',
    ],
    tag: 'Kit Completo',
  },
  {
    ...
    images: [
      '/images/products/kit-rinoplastia/1.jpg',
      '/images/products/kit-rinoplastia/2.jpg',
      '/images/products/kit-rinoplastia/3.jpg',
    ],
    tag: 'Kit Completo',
  },
  {
    ...
    images: [
      '/images/products/kit-blefaroplastia/1.jpg',
      '/images/products/kit-blefaroplastia/2.jpg',
      '/images/products/kit-blefaroplastia/3.jpg',
    ],
    tag: 'Kit Completo',
  },
  {
    ...
    images: [
      '/images/products/equipo-lipo/1.jpg',
      '/images/products/equipo-lipo/2.jpg',
      '/images/products/equipo-lipo/3.jpg',
    ],
    tag: 'Equipo',
  },
]
